...
Record::Record(std::string firstNameTemp, std::string lastNameTemp, int numStreetTemp, std::string streetNameTemp, std::string cityNameTemp, int numPhoneTemp, int monthTemp, int dayTemp, int yearTemp)
{
